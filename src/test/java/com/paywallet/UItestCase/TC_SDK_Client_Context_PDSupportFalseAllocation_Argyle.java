...
public class TC_SDK_Client_Context_PDSupportFalseAllocation_Argyle extends BaseClass {
    String email = emailstring+ randomNum + "@kkdjvj3l.mailosaur.net";
    ...
    public void PDSupportFalse(String employer, String firstname, String lastname, String mon, String amount, String getpaid, String paymentdate, String username, String password, String un, String pass, String ver1) throws InterruptedException {
        ...
        getDriver().get(ClientpdsupportfalseallocationArgyle);
    ...
    private void SDKLoginFlow(String username, String password, String un, String pass, String ver1) throws InterruptedException {
        ...
        UtilityClass.ClientOTP();
        Thread.sleep(2000);
        PDSupportFalse_SDKLoginPage.setSDKUsernameArgyle(un);
        PDSupportFalse_SDKLoginPage.setSDKPasswordArgyle(pass);
        logger.info("SDK email and password entered  Successfully");
        PDSupportFalse_SDKLoginPage.clickConformbutton();
        PDSupportFalse_SDKLoginPage.setVerificationcode(ver1);
        PDSupportFalse_SDKLoginPage.clicksdkVerify();
    ...
    private void KeyClockLoginandCustomerCapureFlow(String employer, String firstname, String lastname, String mon, String amount, String getpaid, String paymentdate) throws InterruptedException {
        ...
        ClearRequestID = UtilityClass.keyClockLoginWithClearRequestID("TC_SDK_Client_Context_PDSupportFalseAllocation_Argyle Request ID is :");
        Thread.sleep(10000);

...
public class TC_SDK_Client_Context_Complete_Verification_AtomicFI extends BaseClass {
    String email = emailstring+ randomNum +"@arcq47ba.mailosaur.net";
    ...
    public void CompleteVerification(String employer,String firstname, String lastname,  String address, String city,String ZIP, String fortin ,
                                     String DOB, String state, String mon, String username, String password, String un, String pass) throws InterruptedException {


        getDriver().get(ClientContextURL);
        KeyClockLoginandCustomerCaptureFlow(employer, firstname, lastname, address, city, ZIP, fortin, DOB, state, mon);


        getDriver().get(completeverificationatomicFI);
    ...
    private void SDKLoginFlow(String username, String password, String un, String pass) throws InterruptedException {
        ...
        CompleteVerification_SDKLoginLink.setSDKUsernameAtomicFI(un);
        CompleteVerification_SDKLoginLink.clickSDKcontinue();
        logger.info("SDK username entered successfully and conformed");
        Thread.sleep(2000);
        CompleteVerification_SDKLoginLink.setSDKPasswordAtomicFI(pass);
        CompleteVerification_SDKLoginLink.clickSDKSigninbutton();
        logger.info("SDK password entered successfully and SignedIn");
        Thread.sleep(25000);
    ...
    private void KeyClockLoginandCustomerCaptureFlow(String employer, String firstname, String lastname, String address, String city, String ZIP, String fortin, String DOB, String state, String mon) throws InterruptedException {
        CC_CustomerCapturePage_Client CompleteVerification = new CC_CustomerCapturePage_Client(getDriver());
        ClearRequestID = UtilityClass.keyClockLoginWithClearRequestID("TC_SDK_Client_Context_Complete_Verification_AtomicFI Request ID is :");
        Thread.sleep(5000);

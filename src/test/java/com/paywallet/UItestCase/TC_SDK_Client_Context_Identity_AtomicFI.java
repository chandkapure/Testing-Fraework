...
public class TC_SDK_Client_Context_Identity_AtomicFI extends BaseClass {
    String email = emailstring+ randomNum +"@koc09tkh.mailosaur.net";
    ...
    public Object[][] getData() throws IOException
    {
        ...
        String IdentityData[][]=new String[totalrows][totalcols];
        for(int i=1;i<=totalrows;i++) //1
        {
            for(int j=0;j<totalcols;j++) //0
            {
                IdentityData[i-1][j]=excel.getS3CellData("Identity", i, j);
            }
        }
        return IdentityData;
    }
    ...
    public void identityVerification(String employer,String firstname, String lastname, String address, String city,String ZIP, String fortin ,
                                     String DOB, String state, String username, String password, String un, String pass) throws InterruptedException {
        ...
        getDriver().get(identityatomicFI);
    ...
    private void SDKLoginFlow(String username, String password, String un, String pass) throws InterruptedException {
        ...
        logger.info("SDK username entered successfully and clicked on Continue");
        Thread.sleep(2000);
        Identity_SDKLoginLink.setSDKPasswordAtomicFI(pass);
        Identity_SDKLoginLink.clickSDKSigninbutton();
        logger.info("SDK password entered successfully and Clicked on SignInButton");
        Thread.sleep(25000);
    ...
    private void KeyClockandCustomerCaptureFlow(String employer, String firstname, String lastname, String address, String city, String ZIP, String fortin, String DOB, String state) throws InterruptedException {
        ...
        ClearRequestID = UtilityClass.keyClockLoginWithClearRequestID("TC_SDK_Client_Context_Identity_AtomicFI Request id is :");
        Thread.sleep(20000);
        ...
        Identity_VerificationPage.setEmailid(email);

...
public class TC_SDK_Okinus_Customer_Context_DepositAllocation_Argyle extends BaseClass {


    String emailid = "DepositallocationArgyle" + randomNum + "@paywalletllc.com";
    ...
    public Object[][] getData() throws IOException
    {
        ...
        int totalrows=excel.getRowCount("OkinusdepositAllocationArgyle");
        int totalcols=excel.getCellCount("OkinusdepositAllocationArgyle",1);
        String loginData[][]=new String[totalrows][totalcols];
        for(int i=1;i<=totalrows;i++) //1
        {
            for(int j=0;j<totalcols;j++) //0
            {
                loginData[i-1][j]=excel.getCellData("OkinusdepositAllocationArgyle", i, j);
            }
        }
        return loginData;
    }
    ...
    public void depostiAllocation(String firstname, String lastname, String employer, String numberofinstalment, String Installmentamout, String firstpaymentdate, String howoftenyougetpaid, String lender,
                                  String otp1, String otp2, String otp3, String otp4, String otp5, String otp6, String username, String password, String code) throws InterruptedException {

...
public class TC_SDK_Customer_Context_ReStart_Verification_Argyle extends BaseClass {

// Abandoned @ MFA screen and restart starts @ Payroll login for All the clients
    String emailid = "VerificationReStartArgyle" + randomNum + "@paywalletllc.com";

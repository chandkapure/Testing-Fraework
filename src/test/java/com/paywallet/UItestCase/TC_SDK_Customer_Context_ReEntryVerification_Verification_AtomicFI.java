...
public class TC_SDK_Customer_Context_ReEntryVerification_Verification_AtomicFI extends BaseClass {
    ...
    public void ReEntry(String firstname, String lastname, String address, String city, String state, String zipcode, String DOB, String fourtin,
        ...
        {
            WebDriverWait waitt = new WebDriverWait(getDriver(), Duration.ofSeconds(60));

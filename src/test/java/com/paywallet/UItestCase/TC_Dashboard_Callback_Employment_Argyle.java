...
public class TC_Dashboard_Callback_Employment_Argyle extends BaseClass {

    String emailid = "employmentArgyle" + randomNum + "@paywalletllc.com";
    CC_CallBack_DashBoard_Page dashBoard;
    String EmpArg_ClearRequestid;
    ...
    public void employmentVerification(String firstname, String lastname, String address, String city, String state, String zipcode, String DOB, String fourtin,
        ...
        EmpArg_ClearRequestid = customercontext.getclearRequestIdtext();
        logger.info("Request id is : " + EmpArg_ClearRequestid);
        ...
        System.out.println("Call back Path URL for Employment Argyle : " + EmploymentURLPath);
        ...
        for (int i = 0; i < elementss.size(); i++) {
            ...
            if(requestId.equals(EmpArg_ClearRequestid))
            {
                strr = CallbackJson;
...
//        String Callback_TerminationDate = jsonObject.get("employmentData").getAsJsonObject().get("terminationDate").getAsString();
        ...
        Thread.sleep(2000);
        dashBoard.searchForRequestIDAndSelectTheRequest(EmpArg_ClearRequestid);
        ...
        dashBoard.checkrequestID(EmpArg_ClearRequestid);

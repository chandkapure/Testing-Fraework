...
public class TC_SDK_Customer_Context_DepositAllocation_Update_Cancel_Argyle extends BaseClass {

    String emailid = "UpdateCancelArgyle" + randomNum + "@paywalletllc.com";
    ...
    public void depostiAllocation(String firstname, String lastname, String address, String city, String state, String zipcode, String DOB, String fourtin,
        ...
        UpdateAllocation(numberofinstalment, Installmentamout, customercontext, requestid,code,Client1,Client2,Client3);

        UtilityClass.compareAllocationCallbackUpdateDashboardData(DepositAllocationURLPath,ClearRequestid);
        UtilityClass.metricReportValidation(ClearRequestid);

        CancelAllocation(customercontext, requestid,code,Client1,Client2,Client3);
    ...
    private void CancelAllocation(CC_Customer_ContextFlow customercontext, String requestid, String code, String Client1,String Client2,String Client3) throws InterruptedException {
        getDriver().get(CustomerContextURL);
    ...
    private void UpdateAllocation(String numberofinstalment, String Installmentamout, CC_Customer_ContextFlow customercontext,
                                  String requestid,String code,String Client1,String Client2,String Client3) throws InterruptedException {
        getDriver().get(CustomerContextURL);
        customercontext.setScrollIntoView();
        Thread.sleep(5000);

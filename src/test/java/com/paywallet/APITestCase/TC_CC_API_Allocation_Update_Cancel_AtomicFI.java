...
public class TC_CC_API_Allocation_Update_Cancel_AtomicFI extends BaseClass
{

    String emailid =  "TC_CC_API_Allocation_Update_Cancel_AtomicFI"+ randomNum +"@guzibdmm.mailosaur.net";
    ...
    public void AllocationUpdateCancelAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_Allocation_Update_Cancel_AtomicFI email id is "+emailid);
        System.out.println("TC_CC_API_Allocation_Update_Cancel_AtomicFI phone number is "+mobile);
//  Employer Type Ahead

...
public class TC_CC_API_EmploymentVerification_Argyle extends BaseClass {

    String emailid =  "TC_CC_API_EmploymentVerification_Argyle"+ randomNum +"@twzar5qu.mailosaur.net";
    ...
    public void EmploymentAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_EmploymentVerification_Argyle email id is "+emailid);
        System.out.println("TC_CC_API_EmploymentVerification_Argyle phone number is "+mobile);
//  Employer Type Ahead

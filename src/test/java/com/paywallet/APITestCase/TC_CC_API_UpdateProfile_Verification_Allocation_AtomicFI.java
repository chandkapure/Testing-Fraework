...
public class TC_CC_API_UpdateProfile_Verification_Allocation_AtomicFI extends BaseClass {

    String emailid =  "TC_CC_API_UpdateProfile_Verification_Allocation_AtomicFI"+ randomNum +"@8aj9hcr3.mailosaur.net";
    ...
    public void UpdateProfileAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_UpdateProfile_Verification_Allocation_AtominFI email id is "+emailid);
        System.out.println("TC_CC_API_UpdateProfile_Verification_Allocation_AtomicFI phone number is "+mobile);
//  Employer Type Ahead
...
//  SDK Login Starts
        ...
        getDriver().get(OkinusAPISkipSDKLoginAtomicFI);

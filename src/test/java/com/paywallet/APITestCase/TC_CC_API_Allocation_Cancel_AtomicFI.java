...
public class TC_CC_API_Allocation_Cancel_AtomicFI extends BaseClass {

    String emailid = "TC_CC_API_Allocation_Cancel_AtomicFI"+ randomNum + "@afotusmw.mailosaur.net";
    ...
    public void AllocationUpdateCancelAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_Allocation_Cancel_AtomicFI email id is "+emailid);
        System.out.println("TC_CC_API_Allocation_Cancel_AtomicFI phone number is "+mobile);
...
//  SDK Login Starts
        AllocationSDKLogin(username, password, un, pass);
...
//        Cancel Profile
    ...
    private void AllocationSDKLogin(String username, String password, String un, String pass) throws InterruptedException {
        getDriver().get(LCOAPICancelAtomicFI);
    ...
    private void CancelSDKLogin() throws InterruptedException {
        getDriver().get(LCOAPICancelAtomicFI);
    ...
    private void UpdateSDKLogin() throws InterruptedException {

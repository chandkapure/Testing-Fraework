...
public class TC_CC_API_Allocation_AtomicFI extends BaseClass {

    String emailid =  "TC_CC_API_Allocation_AtomicFI"+ randomNum +"@lebn3xqj.mailosaur.net";
    ...
    public void DepositAllocationAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_Allocation_AtomicFI email id is "+emailid);
        System.out.println("TC_CC_API_Allocation_AtomicFI phone number is "+mobile);
//  Employer Type Ahead

...
public class TC_CC_API_PostRestart_Allocation_Argyle extends BaseClass {

//    Abandon @Paydistribution Conform and restart @OTP and Payroll login for LCO, and for Luthersales and Okinus restart from Paydistribution Conform page.
    String emailid =  "TC_CC_API_PostRestart_Allocation_Argyle"+ randomNum +"@phm4strh.mailosaur.net";
    ...
    public void DepositAllocationAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_PostRestart_Allocation_Argyle email id is "+emailid);
        System.out.println("TC_CC_API_PostRestart_Allocation_Argyle phone number is "+mobile);
//  Employer Type Ahead

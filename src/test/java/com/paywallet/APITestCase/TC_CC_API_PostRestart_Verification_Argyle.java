...
public class TC_CC_API_PostRestart_Verification_Argyle extends BaseClass {

//    Abandon After OTP restart @ OTP and then Payroll login
// To be added again abandon @ MFA restart done at MFA for Luthersales and okinus but for LCO restart done @ payroll login argyle
//    for Atomic abond at
    String emailid =  "TC_CC_API_PostRestart_Verification_Argyle"+ randomNum +"@ldz42upj.mailosaur.net";
    ...
    public void AffordabilityAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_PostRestart_Verification_Argyle email id is "+emailid);
        System.out.println("TC_CC_API_PostRestart_Verification_Argyle phone number is "+mobile);
//    Employer Type Ahead
...
//    SDK Login Starts
        ...
        getDriver().get(PostRestartArgyle);

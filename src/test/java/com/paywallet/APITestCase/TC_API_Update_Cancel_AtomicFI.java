...
public class TC_API_Update_Cancel_AtomicFI extends BaseClass {

    String emailid = "CancelUpdateAtomicFI+" + randomNum + "@guzibdmm.mailosaur.net";
    UtiltyMethodforAPI methodforAPI = new UtiltyMethodforAPI();



    @Test(dataProvider = "UpdateCancelAtomicFI",dataProviderClass = com.paywallet.Utilities.WrapperAPITestData.class)
    public void APIUpdateCancelAtomicFI(String employer, String firstName, String lastName, String numberofInstalment, String loanamount,
                                              String CCreference, String ACHpull, String AccountVerifiction, String username, String password,
                                              String un, String pass,String NotificationURL, String directallocationURL, String revisedAllocationAmount, String revisedNumberOfInstallment) throws InterruptedException {
...
//      SDK Login Starts
        SDKLoginFlowCancelUpdate(username, password, un, pass);
...
//       Cancel API
    ...
    private void SDKLoginFlowCancel() throws InterruptedException {
        getDriver().get(APIUpdateCancelAtomicFI);
    ...
    private void CancelAPI(String requestID) throws InterruptedException {
        ...
        logger.info("Allocation Cancel Request is sent");
        String body = cancelresponse.getBody().asString();
        logger.info("Allocation Cancel Response is received");
    ...
    private void SDKLoginFlowCancelUpdate(String username, String password, String un, String pass) throws InterruptedException {
        getDriver().get(APIUpdateCancelAtomicFI);

...
public class TC_CC_API_PostRestart_Verification_AtomicFI extends BaseClass {

    String emailid = "TC_CC_API_PostRestart_Verification_AtomicFI"+ randomNum + "@5pq7s5pl.mailosaur.net";
    ...
    public void AffordabilityAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_PostRestart_Verification_AtomicFI email id is "+emailid);
        System.out.println("TC_CC_API_PostRestart_Verification_AtomicFI phone number is "+mobile);
...
//  SDK Login Starts
        ...
        CustomerContext.setsdkUsername(un);
        Thread.sleep(6000);

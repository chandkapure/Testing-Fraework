...
public class TC_CC_API_IncomeVerification_AtomicFI extends BaseClass {

    String emailid =  "TC_CC_API_IncomeVerification_AtomicFI"+ randomNum +"@w3nau2hy.mailosaur.net";
    ...
    public void IncomeAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_IncomeVerification_AtomicFI email id is "+emailid);
        System.out.println("TC_CC_API_IncomeVerification_AtomicFI phone number is "+mobile);
//  Employer Type Ahead
        String employerID = methodforAPI.employerTypeAhead(provider);

        String profiles = "INCOME_VERIFICATION";
...
//  SDK Login Starts
        ...
        {
            Affordebility_ProfileDataLink.verifySalaryInfodisp();
...
//    Fetch Request ID
        IncomeFetchRequestID(RequestID);
    }
    private void IncomeFetchRequestID(String requestID) {

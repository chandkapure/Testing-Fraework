...
public class TC_CC_API_PDSupportFalse_Argyle extends BaseClass{

    String emailid =  "TC_CC_API_PDSupportFalse_Argyle"+ randomNum +"@sncoxjmy.mailosaur.net";
    UtiltyMethodforAPI methodforAPI = new UtiltyMethodforAPI();


    @Test(dataProvider = "CCAPIPdsupportArgyleData",dataProviderClass = CustomDataProvider.class)
    public void DepositAllocationAPI(String provider, String context, String firstName, String middleName, String lastName,
                                     ...
                                     String notificationUrls, String affordabilityCallback, String username, String password, String un, String pass,String code) throws InterruptedException {

        System.out.println("TC_CC_API_PDSupportFalse_Argyle email id is "+emailid);
        System.out.println("TC_CC_API_PDSupportFalse_Argyle phone number is "+mobile);
//  Employer Type Ahead
...
//  SDK Login Starts
        ...
        getDriver().get(APIPDsupportfalseArgyle);
        ...
        Allocation_SDKLoginLink.setVerificationcode(code);

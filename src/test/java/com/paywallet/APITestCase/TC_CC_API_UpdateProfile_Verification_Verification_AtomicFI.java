...
public class TC_CC_API_UpdateProfile_Verification_Verification_AtomicFI extends BaseClass {

    String emailid =  "TC_CC_API_UpdateProfile_Verification_Verification_AtomicFI"+ randomNum +"@wvyrldat.mailosaur.net";
    ...
    public void UpdateProfileAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_UpdateProfile_Verification_Verification_AtomicFI email id is "+emailid);
        System.out.println("TC_CC_API_UpdateProfile_Verification_Verification_AtomicFI phone number is "+mobile);
//  Employer Type Ahead
...
//  SDK Login Starts
        ...
        getDriver().get(APIUpdateProfileVVAtomicFI);

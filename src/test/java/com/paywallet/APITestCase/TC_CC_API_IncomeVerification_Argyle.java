...
public class TC_CC_API_IncomeVerification_Argyle extends BaseClass {

    String emailid =  "TC_CC_API_IncomeVerification_Argyle"+ randomNum +"@vexse4el.mailosaur.net";
    ...
    public void IncomeAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_IncomeVerification_Argyle email id is "+emailid);
        System.out.println("TC_CC_API_IncomeVerification_Argyle phone number is "+mobile);
//  Employer Type Ahead

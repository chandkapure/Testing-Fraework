...
public class TC_CC_API_Allocation_Cancel_Argyle extends BaseClass {

    String emailid = "TC_CC_API_Allocation_Cancel_Argyle"+ randomNum + "@zxkyi3vd.mailosaur.net";
    ...
    public void AllocationCancelAPI(String provider, String context, String firstName, String middleName, String lastName,
        ...
        System.out.println("TC_CC_API_Allocation_Cancel_Argyle email id is "+emailid);
        System.out.println("TC_CC_API_Allocation_Cancel_Argyle phone number is "+mobile);
...
//        Cancel Profile
    ...
    private void AllocationSDKLogin(String username, String password, String un, String pass,String code) throws InterruptedException {
        getDriver().get(APIAllocationCancelArgyle);
